...
function bond_api_install_villians( $films ) {
    $villains = array(
        ...
        array(
            'title' => 'Franz Sanchez',
            'films' => array( 'License to Kill' ),
            'image' => '',
        ),
        array(
            'title' => 'Alec Trevelyan',
            'films' => array( 'GoldenEye' ),
            'image' => 'https://upload.wikimedia.org/wikipedia/en/7/77/Alec_Trevelyan.jpg',
        ),
        array(
            'title' => 'Elliot Carver',
            'films' => array( 'Tomorrow Never Dies' ),
            'image' => '',
        ),
        array(
            'title' => 'Elektra King',
            'films' => array( 'The World Is Not Enough' ),
            'image' => '',
        ),
        array(
            'title' => 'Victor \'Renard\' Zokas',
            'films' => array( 'The World Is Not Enough' ),
            'image' => '',
        ),
        array(
            'title' => 'Gustav Graves',
            'films' => array( 'Die Another Day' ),
            'image' => '',
        ),
        array(
            'title' => 'Colonel Moon',
        ...
        array(
            'title' => 'Le Chiffre',
            'films' => array( 'Casino Royale' ),
            'image' => '',
        ),
        array(
            'title' => 'Mr. White',
            'films' => array( 'Casino Royale', 'Quantum of Solace' ),
            'image' => '',
        ),
        array(
            'title' => 'Dominic Greene',
            'films' => array( 'Quantum of Solace' ),
            'image' => '',
        ),
        array(
            'title' => 'Tiago \'Raoul Silva\' Rodriguez',
            'films' => array( 'Skyfall' ),
            'image' => '',
        ),
        array(
            'title' => 'Franz Oberhauser',
            'films' => array( 'Spectre' ),
            'image' => '',
        ),
        array(
    ...
    foreach ( $villains as $key => $villain_data ) :
        $film_ids = array();
        $villain = get_page_by_title( $villain_data['title'], OBJECT, 'villains' );

        if ( ! $villain ) :
            $post_id = wp_insert_post(
                array(
                    'post_title' => $villain_data['title'],
                    'post_content' => '',
                    'post_type' => 'villains',
                    'post_status' => 'publish',
                )
        ...
        foreach ( $films as $film ) :
            if ( in_array( $film['title'], $villain_data['films'] ) ) :
                $film_ids[] = $film['id'];
            endif;
        endforeach;

        // add meta.
        update_post_meta( $post_id, '_film_ids', $film_ids );

        // set featured image.
        if ( ! has_post_thumbnail( $post_id ) ) :
            bond_api_install_insert_image( $villain_data['image'], $post_id );
        endif;
    endforeach;
